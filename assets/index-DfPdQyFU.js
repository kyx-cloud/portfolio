...
void main() {
	...
	#include <fog_fragment>
		...
		`,blending:Ar,depthTest:!1,depthWrite:!1})}function ad(){return new Lr({name:"EquirectangularToCubeUV",uniforms:{envMap:{value:null}},vertexShader:Uh(),fragmentShader:`
		...
		`,blending:Ar,depthTest:!1,depthWrite:!1})}function ld(){return new Lr({name:"CubemapToCubeUV",uniforms:{envMap:{value:null},flipEnvMap:{value:-1}},vertexShader:Uh(),fragmentShader:`
...
`)+`
`+p);const T=S+m+o,x=S+p+a,A=_d(i,i.VERTEX_SHADER,T),w=_d(i,i.FRAGMENT_SHADER,x);i.attachShader(_,A),i.attachShader(_,w),t.index0AttributeName!==void 0?i.bindAttribLocation(_,0,t.index0AttributeName):t.morphTargets===!0&&i.bindAttribLocation(_,0,"position"),i.linkProgram(_);function b(I){if(s.debug.checkShaderErrors){const O=i.getProgramInfoLog(_).trim(),k=i.getShaderInfoLog(A).trim(),X=i.getShaderInfoLog(w).trim();let q=!0,Y=!0;if(i.getProgramParameter(_,i.LINK_STATUS)===!1)if(q=!1,typeof s.debug.onShaderError=="function")s.debug.onShaderError(i,_,A,w);else{const W=xd(i,A,"vertex"),H=xd(i,w,"fragment");console.error("THREE.WebGLProgram: Shader Error "+i.getError()+" - VALIDATE_STATUS "+i.getProgramParameter(_,i.VALIDATE_STATUS)+`
